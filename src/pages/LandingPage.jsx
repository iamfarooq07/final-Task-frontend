...
function GlowBlobs() {
  return (
    <>
      <div
        className="absolute top-[-220px] left-[-180px] w-[650px] h-[650px] rounded-full pointer-events-none"
        style={{
          background:
            "radial-gradient(circle, rgba(0,123,255,0.13) 0%, transparent 70%)",
          filter: "blur(50px)",
        }}
      />
      <div
        className="absolute top-[180px] right-[-160px] w-[550px] h-[550px] rounded-full pointer-events-none"
        style={{
          background:
            "radial-gradient(circle, rgba(138,43,226,0.11) 0%, transparent 70%)",
          filter: "blur(50px)",
        }}
      />
      <div
        className="absolute bottom-[100px] left-[30%] w-[400px] h-[400px] rounded-full pointer-events-none"
        style={{
          background:
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.color = "#60b4ff";
          }}
          onMouseLeave={(e) => {
...
function HeroIllustration() {
  return (
    ...
    >
      ...
      {/* Mock phone card */}
      <div
        className="relative w-[260px] rounded-[2.5rem] overflow-hidden shadow-2xl"
        style={{
          background:
            "linear-gradient(160deg, rgba(20,20,35,0.95), rgba(10,10,20,0.98))",
          border: "1px solid rgba(0,123,255,0.25)",
          boxShadow:
            "0 30px 80px rgba(0,0,0,0.6), 0 0 40px rgba(0,123,255,0.12)",
        }}
      >
        {/* Status bar */}
        ...
        <div className="flex flex-col items-center pt-4 pb-6 px-6 gap-3">
          ...
          {/* Link cards */}
          {["Portfolio", "Twitter / X", "GitHub", "Dribbble"].map(
            (label, i) => (
              <motion.div
                key={label}
...
export default function LandingPage() {
  ...
  const features = [
    {
      ...
      desc: "Share all your socials, projects, and content from a single personalized URL.",
      accentColor: "#007bff",
      delay: 0,
    },
    {
      Icon: FiZap,
      title: "Instant Setup",
      desc: "Get your profile live in under 2 minutes. No coding required — just fill and publish.",
      accentColor: "#8a2be2",
      delay: 0.08,
    },
    {
      ...
      desc: "Track clicks and engagement on every link you share with real-time insights.",
      accentColor: "#007bff",
      delay: 0.16,
    },
    {
      ...
      desc: "Choose themes, colors, and layouts that match your personal brand perfectly.",
      accentColor: "#8a2be2",
      delay: 0.24,
    },
    {
      Icon: FiSmartphone,
      title: "Mobile First",
      desc: "Looks stunning on every device. Optimized for the way your audience browses.",
      accentColor: "#007bff",
      delay: 0.32,
    },
    {
      ...
      desc: "Your data is protected with JWT auth and industry-standard security practices.",
      accentColor: "#8a2be2",
      delay: 0.4,
    },
  ];
  ...
  return (
    ...
    >
        ...
        <div className="flex-1 flex flex-col items-start gap-6 max-w-xl">
          ...
          >
            ...
            <span
              ...
              style={{
                backgroundImage:
                  "linear-gradient(90deg, #007bff 0%, #8a2be2 100%)",
              }}
            >
              Rule Them All
            </span>
          ...
          >
            Build your personal link-in-bio page in minutes. Share your socials,
            projects, and content — all from one beautiful, customizable
            profile.
          </motion.p>
          ...
          >
            <motion.button
              whileHover={{
                scale: 1.06,
                boxShadow: "0 8px 32px rgba(0,123,255,0.5)",
              }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate("/signup")}
              ...
              style={{
                background: "linear-gradient(135deg, #007bff, #8a2be2)",
                boxShadow: "0 4px 24px rgba(0,123,255,0.35)",
              }}
            >
          ...
          >
            ...
            <p className="text-xs text-gray-500">
              <span className="text-white font-semibold">2,400+</span> creators
              already onboard
            </p>
          </motion.div>
        </div>
      ...
      <section
        id="features"
        className="relative px-6 md:px-14 pb-28 max-w-6xl mx-auto"
      >
        <motion.div
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-black text-white">
            ...
            <span
              className="bg-clip-text text-transparent"
              style={{
                backgroundImage: "linear-gradient(90deg, #007bff, #8a2be2)",
              }}
            >
              nothing you don't
            </span>
      ...
      <section id="cta" className="px-6 pb-28 max-w-4xl mx-auto">
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(0,123,255,0.1), rgba(138,43,226,0.12))",
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at center, rgba(0,123,255,0.08) 0%, transparent 70%)",
            }}
          />
          ...
          <motion.button
            whileHover={{
              scale: 1.06,
              boxShadow: "0 8px 36px rgba(138,43,226,0.5)",
            }}
            whileTap={{ scale: 0.95 }}
            onClick={() => navigate("/signup")}
            ...
            style={{
              background: "linear-gradient(135deg, #007bff, #8a2be2)",
              boxShadow: "0 4px 24px rgba(138,43,226,0.35)",
            }}
          >
      ...
      {/* ── Footer ── */}
      <footer
        className="border-t py-8 text-center text-gray-700 text-sm"
