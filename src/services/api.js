...
export const getProfile = () =>
  axios.get(`${API_URL}/api/profile`, authHeaders());

export const updateProfile = (data) =>
  axios.put(`${API_URL}/api/profile`, data, authHeaders());

export const getPublicProfile = (username) =>
  axios.get(`${API_URL}/api/u/${username}`);

export const incrementClick = (linkId) =>
  axios.post(`${API_URL}/api/links/${linkId}/click`);
